...
number_of_entries_prok_tax_short <- best_tax_prok_tax_short %>% count(taxonomy_short, sort = T )
number_of_entries_prok_genus <- best_tax_prok_genus %>% count(genus, sort = T )
